...
void Triangle::draw(Canvas* canvas, int x1, int y1, int x2, int y2, int x3, int y3, Color color, int pattern)
{
...
void Triangle::draw_filled(Canvas* canvas, int x1, int y1, int x2, int y2, int x3, int y3, Color color)
{
...
void Triangle::draw_filled_withBias(Canvas* canvas, int x1, int y1, int x2, int y2, int x3, int y3, Color color)
{
    int xMin = std::min({x1, x2, x3});
    int yMin = std::min({y1, y2, y3});
    int xMax = std::max({x1, x2, x3});
